...
export const createApiAction = <P1 = any, P2 = any, P3 = any, P4 = any>(
  actionType: string,
  payloadCreator: ActionFunction0<IRequestAction>
  ...
  const actionCreator = createAction<any, P1, P2, P3, P4>(actionType, payloadCreator) as any;
  actionCreator.toString = () => actionType;
  actionCreator.request = actionType;

...
export const createApiAction = (siteKey: string, actionName: string = 'submit', verifyCallback?: (token: string) => any,  throwError: boolean = true): { execute: Promise<string>; isReady: boolean; } => {
